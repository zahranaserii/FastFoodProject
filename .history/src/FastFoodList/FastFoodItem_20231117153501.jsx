...
const FastFoodItem = ({ items }) => {
  return (
    <div className="relative">
      ...
      <img src={items.imageUrl} className="hover:px-1 duration-500" alt="" />
      ...
      <div className="flex flex-col items-center py-1 px-2">
        ...
        <span className="text-[10px] text-slate-600 my-2">
          {items.ingredients}
        </span>
        <Button size="small" className="relative" type="default">
          افزودن به سبد خرید
        </Button>
      </div>
    </div>
