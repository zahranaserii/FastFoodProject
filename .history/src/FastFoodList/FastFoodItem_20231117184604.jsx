...
const FastFoodItem = ({ imageUrl, price, name, ingredients, filterItems }) => {
  return (
    <div className="relative">
      ...
      <div className="flex flex-col items-center py-4 px-5">
        ...
        <button
          size="small"
          className="flex text-sm justify-center items-center gap-1 w-full my-auto bg-transparent rounded-md py-0.5 border border-orange-500 text-orange-700 hover:text-white hover:bg-orange-700"
          type="default"
        >
